 ...
 *
 */
public abstract class BaseResultsItemBuilder implements ResultsItemBuilder {
	...
	public String getNotLayoutBoundJournalArticleUrl(
		...
		Layout layout = NgpSearchUtil.getLayoutByFriendlyURL(
			_portletRequest, _assetPublisherPageFriendlyURL);

		String assetPublisherInstanceId =
			NgpSearchUtil.findDefaultAssetPublisherInstanceId(layout);
	...
	protected Summary getSummary()
		...
		_log.info("Summary: " + _summary.getContent());
	...
	private static final Log _log =
		LogFactoryUtil.getLog(BaseResultsItemBuilder.class);
}
